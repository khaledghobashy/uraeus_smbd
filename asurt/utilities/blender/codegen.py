...
class script_generator(object):
    ...
    def write_imports(self):
        text = '''
                ...
                from asurt.utilities.blender.numcls import bpy_scene
                from asurt.utilities.numerics.spatial_alg import centered, mirrored
                from asurt.utilities.blender.objects import (cylinder_geometry,
                                                             composite_geometry,
                                                             triangular_prism)
                '''
