...
class blender_scene(object):
    ...
    def __init__(self,prefix=''):
        ...
        self._inputs = ['hpr_lcaf', 'hpr_lcar', 's_tire_radius', 's_links_ro', 's_strut_inner', 'hpr_wc', 'hpr_lcao', 'hpr_tri', 'hpr_ucaf', 's_thickness', 'hpr_strut_lca', 'hpr_strut_chassis', 'hpr_tro', 'hpr_ucao', 'hpr_ucar', 's_strut_outer']
