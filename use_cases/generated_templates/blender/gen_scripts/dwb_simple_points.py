...
class blender_scene(object):
    ...
    def __init__(self,prefix=''):
        ...
        self._inputs = ['hpr_tri', 'hpr_ucar', 'hpr_lcaf', 's_thickness', 'hpr_wc', 's_tire_radius', 's_strut_outer', 's_links_ro', 'hpr_strut_lca', 'hpr_ucao', 's_strut_inner', 'hpr_lcar', 'hpr_lcao', 'hpr_tro', 'hpr_strut_chassis', 'hpr_ucaf']
