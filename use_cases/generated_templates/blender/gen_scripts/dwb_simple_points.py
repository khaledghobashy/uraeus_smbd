...
class blender_scene(object):
    ...
    def __init__(self,prefix=''):
        ...
        self.s_tire_radius = 20
        self.hpr_lcar = np.array([[0], [0], [0]],dtype=np.float64)

        self._inputs = ['s_strut_inner', 's_links_ro', 's_thickness', 'hpr_ucaf', 'hpr_wc', 'hpr_ucao', 'hpr_strut_chassis', 'hpr_tri', 'hpr_lcaf', 's_strut_outer', 'hpr_tro', 'hpr_ucar', 'hpr_lcao', 'hpr_strut_lca', 's_tire_radius', 'hpr_lcar']
