...
class blender_scene(object):
    ...
    def __init__(self,prefix=''):
        ...
        self._inputs = ['s_strut_inner', 'hpr_wc', 'hpr_ucao', 'hpr_tri', 'hpr_tro', 's_strut_outer', 'hpr_strut_lca', 's_tire_radius', 'hpr_ucaf', 'hpr_lcao', 'hpr_ucar', 'hpr_strut_chassis', 'hpr_lcaf', 's_thickness', 's_links_ro', 'hpr_lcar']
