...
class blender_scene(object):
    ...
    def __init__(self,prefix=''):
        ...
        self._inputs = ['hps_upper_3', 'hps_middle_2', 's_rockers_ro', 'hps_middle_3', 'hps_upper_1', 'hps_bottom_1', 'hps_middle_1', 'hps_upper_2', 'hps_bottom_2', 'hps_bottom_3', 's_links_ro']
