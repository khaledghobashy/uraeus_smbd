...
class blender_scene(object):
    ...
    def __init__(self,prefix=''):
        ...
        self._inputs = ['hpr_ucaf', 'hpr_strut_lca', 's_strut_outer', 'hpr_lcaf', 'hpr_tro', 's_strut_inner', 's_thickness', 'hpr_lcar', 's_links_ro', 'hpr_lcao', 'hpr_tri', 's_tire_radius', 'hpr_wc', 'hpr_ucao', 'hpr_ucar', 'hpr_strut_chassis']
