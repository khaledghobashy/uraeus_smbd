...
class blender_scene(object):
    ...
    def __init__(self,prefix=''):
        ...
        self.hpr_strut_mid = np.array([[0], [0], [0]],dtype=np.float64)*scale
        ...
        self._inputs = ['hpr_lcar', 'hpr_ucar', 's_thickness', 'hpr_wc', 'hpr_strut_mid', 'hpr_tri', 'hpr_strut_lca', 's_strut_inner', 'hpr_lcao', 'hpr_tro', 'hpr_lcaf', 'hpr_ucao', 'hpr_ucaf', 's_links_ro', 's_strut_outer', 'hpr_strut_chassis', 's_hub_radius']
    ...
    def create_scene(self):
        ...
        self.gmr_hub = cylinder_geometry(self.hpr_wc, {R_{rbr_upright}}, self.s_hub_radius)
        ...
        self.gml_hub = cylinder_geometry(self.hpl_wc, {R_{rbl_upright}}, self.s_hub_radius)
