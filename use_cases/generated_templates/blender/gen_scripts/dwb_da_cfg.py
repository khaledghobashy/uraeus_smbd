...
class blender_scene(object):
    ...
    def __init__(self,prefix=''):
        ...
        self._inputs = ['hpr_lcaf', 'hpr_ucar', 'hpr_ucaf', 's_tire_radius', 's_strut_inner', 'hpr_strut_lca', 'hpr_lcao', 'hpr_lcar', 's_strut_outer', 'hpr_tro', 's_thickness', 's_links_ro', 'hpr_ucao', 'hpr_strut_chassis', 'hpr_tri', 'hpr_wc']
