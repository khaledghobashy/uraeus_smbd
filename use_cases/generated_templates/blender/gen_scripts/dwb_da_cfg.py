...
class blender_scene(object):
    ...
    def __init__(self,prefix=''):
        ...
        self._inputs = ['hpr_lcaf', 'hpr_tri', 's_strut_inner', 's_strut_outer', 'hpr_lcar', 's_tire_radius', 's_thickness', 'hpr_strut_chassis', 'hpr_wc', 'hpr_ucao', 'hpr_lcao', 'hpr_ucar', 'hpr_strut_lca', 'hpr_tro', 'hpr_ucaf', 's_links_ro']
