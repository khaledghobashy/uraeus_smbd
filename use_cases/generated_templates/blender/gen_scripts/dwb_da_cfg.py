...
class blender_scene(object):
    ...
    def __init__(self,prefix=''):
        ...
        self._inputs = ['s_links_ro', 'hpr_tro', 'hpr_strut_lca', 's_thickness', 'hpr_ucaf', 's_strut_outer', 'hpr_lcaf', 'hpr_strut_chassis', 'hpr_ucao', 'hpr_lcao', 'hpr_ucar', 's_strut_inner', 'hpr_lcar', 's_tire_radius', 'hpr_wc', 'hpr_tri']
