...
class blender_scene(object):
    ...
    def __init__(self,prefix=''):
        ...
        self._inputs = ['s_thickness', 's_strut_inner', 'hpr_lcao', 'hpr_lcaf', 's_links_ro', 'hpr_ucaf', 'hpr_tri', 's_hub_radius', 'hpr_strut_lca', 'hpr_lcar', 's_strut_outer', 'hpr_tro', 'hpr_ucar', 'hpr_wc', 'hpr_ucao', 'hpr_strut_chassis']
