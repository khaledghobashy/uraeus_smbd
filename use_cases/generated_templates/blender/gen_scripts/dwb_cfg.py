...
class blender_scene(object):
    ...
    def __init__(self,prefix=''):
        ...
        self._inputs = ['s_strut_outer', 'hpr_wc', 'hpr_strut_lca', 'hpr_ucar', 'hpr_lcaf', 's_strut_inner', 'hpr_lcar', 's_hub_radius', 's_thickness', 'hpr_tro', 's_links_ro', 'hpr_strut_chassis', 'hpr_ucaf', 'hpr_lcao', 'hpr_ucao', 'hpr_tri']
