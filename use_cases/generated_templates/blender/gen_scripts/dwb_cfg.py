...
class blender_scene(object):
    ...
    def __init__(self,prefix=''):
        ...
        self._inputs = ['s_thickness', 'hpr_lcao', 'hpr_ucao', 'hpr_ucaf', 'hpr_tro', 'hpr_strut_chassis', 'hpr_ucar', 'hpr_strut_lca', 's_hub_radius', 's_strut_outer', 's_links_ro', 'hpr_lcaf', 's_strut_inner', 'hpr_tri', 'hpr_wc', 'hpr_lcar']
