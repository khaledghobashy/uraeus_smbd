...
class numerical_assembly(object):
    ...
    def __init__(self):
        ...
        self.interface_map = {'SU1.vbs_chassis': 'ground', 'SU1.vbl_steer': 'ST.rbl_rocker', 'SU1.vbr_steer': 'ST.rbr_rocker', 'SU1.vbs_ground': 'ground', 'ST.vbs_chassis': 'ground', 'ST.vbs_ground': 'ground', 'TR.vbs_ground': 'ground', 'TR.vbs_chassis': 'ground', 'TR.vbr_upright': 'SU1.rbr_upright', 'TR.vbl_hub': 'SU1.rbl_hub', 'TR.vbl_upright': 'SU1.rbl_upright', 'TR.vbr_hub': 'SU1.rbr_hub', 'TR.vbs_steer_gear': 'ST.rbr_rocker'}
