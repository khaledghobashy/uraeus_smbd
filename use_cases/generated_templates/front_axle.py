...
class numerical_assembly(object):
    ...
    def __init__(self):
        ...
        self.interface_map = {'SU1.vbr_steer': 'ST.rbr_rocker', 'SU1.vbs_ground': 'ground', 'SU1.vbl_steer': 'ST.rbl_rocker', 'SU1.vbs_chassis': 'ground', 'ST.vbs_chassis': 'ground', 'ST.vbs_ground': 'ground'}
