...
f.SU1.config.load_from_csv('temp_front_axle/dwb_v1_mod2.csv')
f.ST.config.load_from_csv('temp_front_axle/steer_v1_mod2.csv')
...
plt.plot(vertical_travel,pos.T[(7*14)+1])
plt.grid()
plt.show()
