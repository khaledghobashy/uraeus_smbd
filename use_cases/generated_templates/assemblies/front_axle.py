...
class numerical_assembly(object):
    ...
    def __init__(self):
        ...
        self.interface_map = {'SU.vbl_steer': 'ST.rbl_rocker', 'SU.vbs_chassis': 'ground', 'SU.vbs_ground': 'ground', 'SU.vbr_steer': 'ST.rbr_rocker', 'ST.vbs_chassis': 'ground', 'ST.vbs_ground': 'ground', 'TR.vbs_steer_gear': 'ST.rbr_rocker', 'TR.vbr_upright': 'SU.rbr_upright', 'TR.vbs_chassis': 'ground', 'TR.vbs_ground': 'ground', 'TR.vbr_hub': 'SU.rbr_hub', 'TR.vbl_hub': 'SU.rbl_hub', 'TR.vbl_upright': 'SU.rbl_upright'}
