...
assm.PD.config.load_from_csv(asurt_path + r'\use_cases\generated_templates\configurations\csv_files\pendulum_cfg_mod.csv')
...
soln._extract_independent_coordinates()
