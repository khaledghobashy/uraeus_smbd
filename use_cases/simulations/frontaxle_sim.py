...
f.SU.config.load_from_csv(r'C:\Users\khaled.ghobashy\Desktop\Khaled Ghobashy\Mathematical Models\asurt_cdt_symbolic\use_cases\generated_templates\configurations\csv_files\dwb_st500_axletech_3.csv')
f.ST.config.load_from_csv(r'C:\Users\khaled.ghobashy\Desktop\Khaled Ghobashy\Mathematical Models\asurt_cdt_symbolic\use_cases\generated_templates\configurations\csv_files\steer_st500_axletech_2.csv')
f.TR.config.load_from_csv(r'C:\Users\khaled.ghobashy\Desktop\Khaled Ghobashy\Mathematical Models\asurt_cdt_symbolic\use_cases\generated_templates\configurations\csv_files\test_rig_v1_mod.csv')
...
vertical_travel = np.array(list(map(f.TR.config.AF_mcr_ver_act,soln.time_array)))
...
plt.figure(figsize=(8,4))
plt.plot(soln.time_array,soln.pos_dataframe['ST.rbr_rocker.y'])
plt.grid()
plt.show()
