...
class numerical_assembly(object):
    ...
    def eval_constants(self):
        ...
        TS.config.R_vbr_hub = SU1.config.R_rbr_hub
        TS.config.P_vbr_hub = SU1.config.P_rbr_hub
        TS.config.R_vbl_hub = SU1.config.R_rbl_hub
        TS.config.P_vbl_hub = SU1.config.P_rbl_hub
        TS.config.R_vbl_upright = SU1.config.R_rbl_upright
        TS.config.P_vbl_upright = SU1.config.P_rbl_upright
        TS.config.R_vbs_ground = self.R_ground
        TS.config.P_vbs_ground = self.P_ground
        TS.config.R_vbr_upright = SU1.config.R_rbr_upright
        TS.config.P_vbr_upright = SU1.config.P_rbr_upright
